    ...
    .then((response) => {
      ...
      if (member.membership.name === 'AP Guru SAT Students') {
        ...
        document.querySelector('.reading-topics-stat').innerHTML =
          response.stats.readingTopicsCompleted;
        document.querySelector('.writing-topics-stat').innerHTML =
          response.stats.writingTopicsCompleted;
      } else {
        document.querySelector('.completed-topics-stat').innerHTML =
          response.stats.totalTopicsCompleted;
      }
